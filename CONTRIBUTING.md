# Contributing to skinned-rat-orm

Thank you for your interest in contributing to skinned-rat-orm! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/skinned-rat-orm.git
   ```
...
Please check the [issues](https://github.com/skinned-rat-orm/issues) tab to see where help is needed.
...
By contributing to skinned-rat-orm, you agree that your contributions will be licensed under the same license as the project.
